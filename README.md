...
<pre><code><strong>Code 1.2</strong>
...
<pre><code><strong>Cdoe 1.3</strong>
import greenfoot.*;
public space_backround_1()
    {
        super(960, 540, 1, true);
